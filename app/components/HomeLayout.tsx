  ...
  return (
    <div className="max-w-screen-2xl mx-auto flex flex-col items-stretch min-h-screen">
      ...
      <div className="flex  flex-col flex-grow  md:px-10 px-4 items-center ">
        ...
        <div className="grow ">
          <div className=" md:gap-10 gap-8 flex-col justify-items-center  grid md:grid-cols-3 mb-12 w-full items-stretch justify-centers">
            <div className="grow w-80  flex flex-col md:justifystart justify-center space-y-4  md:items-start items-center   ">
              <div className="text-[#1B45B4] dark:text-blue-500">
                ...
                >
                  <title>API</title>
                  <path d="M432.4 453.5l-17 46.7h34.4z" fill="transparent" />
                  <path
            ...
            <div className="w-80  flex  flex-col  space-y-4 md:items-start items-center  ">
              <div className="text-[#1B45B4] dark:text-blue-500 ">
                <svg
                  className="md:w-14 md:h-14 w-12 h-12 p-2"
                  fill="currentColor"
                  viewBox="0 0 512 512"
                  id="svg2793"
                  version="1.1"
            ...
            <div className="w-80  flex flex-col space-y-4  md:items-start items-center">
              <div className=" text-[#1B45B4] dark:text-blue-500 bg-gradient-to-br  ">
                <svg
                  ...
                  strokeWidth="1"
                  stroke="currentColor"
                  className="md:w-14 md:h-14 w-12 h-12 p-1"
                >
            ...
            <div className="w-80  flex flex-col  space-y-4 md:items-start items-center">
              ...
              <div className="flex flex-col space-y-2  justify-center items-center md:items-start">
                <div className="text-xl font-semibold">Fully Customized</div>
                <div className="text-md text-secondary w-3/4">
                  Automate your business processes and stay ahead of competition
                  with our AI solutions
                </div>
      ...
      <div className="py-20 max-w-screen-xl px-4 mx-auto border-t mt-8 md:px-20">
        <div>
          <div className="mb-8 text-4xl font-bold">Solution You Can Trust</div>

          <div>
            With multiple integrations and a robust API, you can easily connect
            your existing tools and workflows to our platform. Our solution is
            designed to grow with your business, providing the flexibility and
            scalability you need to succeed.
          </div>
        </div>

        <div className="  rounded-2xl   flex   justify-start md:h-48 py-10 ">
      ...
      <div className="bg-gradient-to-b dark:from-neutral-900/50 dark:to-neutral-900/10  flex md:space-x-8 border-t  flex-col  md:px-10 px-4 py-14">
        ...
        <div className="flex flex-col space-y-2 mb-16 items-centers justify-center">
          ...
          <div className="text-secondary text-center">
            The only all-inclusive platform on the market with proven record of
            success.
          </div>
        </div>
        ...
        <div className="flex flex-col md:space-x-8 space-x-0 space-y-8 md:space-y-0 from-neutral-300 to-neutral-100  md:flex-row items-center justify-center   mb-10 ">
          <div className="grow flex space-y-4 flex-col p-6   items-center md:items-start">
            ...
            <div className="flex flex-col justify-center md:justify-start">
              ...
              <div className="tex-lg">
                ...
                week. We offer training and consultation on any Pigu
          ...
          <div className=" grow flex space-y-4 flex-col p-6  rounded items-center md:items-start">
            ...
            <div className="flex flex-col justify-center md:justify-start">
              ...
              <div className="tex-lg text-secondary">
                Proven track record of rapid growth and profitability. Make Pigu
                is your new expansion strategy with no risks and lengthy
                development.
              </div>
            </div>
          </div>
          ...
          <div className=" grow flex space-y-4 flex-col p-6   items-center md:items-start">
            ...
            <div className="flex flex-col justify-center md:justify-start">
              ...
              <div className="tex-lg">
                No additional resources needed. Simple order management, full
                ERP integration, automatic price correction.{" "}
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col md:px-10 px-4">
        <div className="flex flex-col space-y-2 mb-16 items-centers justify-center">
          <div className="text-center  text-4xl font-bold ">Win with Pigu</div>
          <div className="text-secondary text-center">
            Marketplace era is here. Stay on top of the game. Launch fast, scale
            smart and take the market share,
          </div>
        </div>
            ...
            <div className="tex-lg">
              <ul className="flex flex-col space-y-2 text-lg">
                <li className="flex items-center">
                  Process 10,000+ orders with one person
                </li>
                <li>Auto-correction pricing beats competitors automatically</li>
